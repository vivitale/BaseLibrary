...
public class CalendarPickerView extends ListView {
  ...
  public CalendarPickerView(Context context, AttributeSet attrs) {
    ...
    dividerColor = a.getColor(R.styleable.CalendarPickerView_TS_dividerColor,
        res.getColor(R.color.calendar_divider));
    dayBackgroundResId = a.getResourceId(R.styleable.CalendarPickerView_TS_dayBackground,
        R.drawable.calendar_bg_selector);
    dayTextColorResId = a.getResourceId(R.styleable.CalendarPickerView_TS_dayTextColor,
    ...
    displayHeader = a.getBoolean(R.styleable.CalendarPickerView_TS_displayHeader, true);
    headerTextColor = a.getColor(R.styleable.CalendarPickerView_TS_headerTextColor,
        res.getColor(R.color.calendar_text_active));
    a.recycle();
