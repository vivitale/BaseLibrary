...
public abstract class BaseGroupAdapter<G, C> extends BaseAdapter
{
	...
	public void setOnGroupItemLongClickListener(
		OnGroupItemLongClickListener onGroupItemLongClickListener)
	{
	...
	@Override public int getItemViewType(int position)
	{
		...
		{
			return getChildViewType( getGroupPosition( position ),
				getChildPositionInGroup( position ) );
		}
	}
	...
	@Override public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		{
			return getChildView( groupPosition, getChildPositionInGroup( position ), convertView,
				parent );
		}
		return null;
	}
