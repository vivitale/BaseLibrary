 ...
 */
public class NavJavaCodeFragment extends BaseNavigationFragment
	implements OnRefreshListener, OnLoadMoreListener
{
	...
	private void showConfigDialog()
	{
		...
		{
			View view =
				LayoutInflater.from( getActivity() ).inflate( R.layout.layout_dialog_config, null );
			initDialogView( view );
	...
	private void changeFooter(int i)
	{
		...
		switch(i)
		{
			case 0:
				view =
					mInflater.inflate( R.layout.layout_classic_footer, swipeToLoadLayout, false );
				break;
			case 2:
			...
			case 1:
				view = mInflater
					.inflate( R.layout.layout_google_hook_footer, swipeToLoadLayout, false );
				break;
		}
		if(view != null)
		{
	...
	private void changeHeader(int i)
	{
		...
		switch(i)
		{
			case 0:
				view =
					mInflater.inflate( R.layout.layout_twitter_header, swipeToLoadLayout, false );
				break;
			case 1:
				view = mInflater
					.inflate( R.layout.layout_google_hook_header, swipeToLoadLayout, false );
				break;
			case 2:
