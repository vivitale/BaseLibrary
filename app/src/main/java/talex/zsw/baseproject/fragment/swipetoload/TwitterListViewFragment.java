...
import talex.zsw.baseproject.adapter.swipetoload.LoopViewPagerAdapter;
 ...
 */
public class TwitterListViewFragment extends Fragment
        ...
        listView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                if (scrollState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE) {
                    if (view.getLastVisiblePosition() == view.getCount() - 1 && !ViewCompat
    ...
    public void onRefresh() {
        ...
        MyApplication.getRequestQueue().add(request).setTag(TAG);
    }
