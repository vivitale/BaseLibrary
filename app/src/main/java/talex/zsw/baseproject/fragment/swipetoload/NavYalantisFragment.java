...
import talex.zsw.baseproject.adapter.swipetoload.BaseArrayAdapter;
...
public class NavYalantisFragment extends BaseNavigationFragment implements OnRefreshListener
{
	...
	@Override public void onCreate(Bundle savedInstanceState)
	{
		...
		int[] icons =
			{R.mipmap.yalantis_icon_1, R.mipmap.yalantis_icon_2, R.mipmap.yalantis_icon_3};

		int[] colors =
			{R.color.yalantis_saffron, R.color.yalantis_eggplant, R.color.yalantis_sienna};
		...
		public View getView(final int position, View convertView, @NonNull ViewGroup parent)
		{
			...
			if(convertView == null)
			{
				...
				convertView = LayoutInflater.from( parent.getContext() )
					.inflate( R.layout.item_yalantis, parent, false );
