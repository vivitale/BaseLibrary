...
public class NavTwitterFragment extends BaseNavPagerFragment
{
	...
	@Override protected String[] getTitles()
	{
		return new String[]{"ListView", "GridView", "RecyclerView", "Grid RecyclerView",
			"StaggeredGrid RecyclerView", "ScrollView", "WebView", "FrameLayout", "RelativeLayout",
	...
	@Override protected Fragment getFragment(int position)
	{
		...
		{
			fragment =
				TwitterRecyclerFragment.newInstance( TwitterRecyclerFragment.TYPE_STAGGERED_GRID );
		}
		...
		else if(title.equals( "FrameLayout" ) || title.equals( "RelativeLayout" ) ||
			title.equals( "LinearLayout" ) || title.equals( "ImageView" ) ||
