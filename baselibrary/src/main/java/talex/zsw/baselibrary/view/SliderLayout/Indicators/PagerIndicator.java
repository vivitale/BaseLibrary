package talex.zsw.baselibrary.view.SliderLayout.Indicators;
...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener{
    ...
    /**
     * bind this Indicator with {@link talex.zsw.baselibrary.view.SliderLayout.Tricks.ViewPagerEx}
     */
    ...
    /**
     *This value is from {@link talex.zsw.baselibrary.view.SliderLayout.SliderAdapter} getRealCount() represent
     *
