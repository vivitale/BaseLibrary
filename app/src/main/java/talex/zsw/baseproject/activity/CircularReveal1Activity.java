...
public class CircularReveal1Activity extends AppCompatActivity
	implements ViewTreeObserver.OnGlobalLayoutListener
{
	private static final float[] TEMP_HSL = new float[]{0, 0, 0};
	private static final Creation[] REVEAL_CREATORS =
		new Creation[]{new LeftTopSide(), new RightTopSide(), new RightBottomSide(),
			new LeftBottomSide()};
	...
	private SupportAnimator.SimpleAnimatorListener mCard1AnimatorListener =
	...
	private SupportAnimator.SimpleAnimatorListener mCard2AnimatorListener =
		new SupportAnimator.SimpleAnimatorListener()
		{
			@Override public void onAnimationEnd()
			{
	...
	{
		@Override public SupportAnimator create(View view, Rect bounds)
		{
