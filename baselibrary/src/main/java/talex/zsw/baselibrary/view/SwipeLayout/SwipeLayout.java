package talex.zsw.baselibrary.view.SwipeLayout;
...
public class SwipeLayout extends FrameLayout
{
	...
	public SwipeLayout(Context context, AttributeSet attrs, int defStyle)
	{
		...
		int dragEdgeChoices = a.getInt(R.styleable.SwipeLayout_SL_drag_edge, DRAG_RIGHT);
		mEdgeSwipesOffset[DragEdge.Left.ordinal()] =
			a.getDimension(R.styleable.SwipeLayout_SL_leftEdgeSwipeOffset, 0);
		mEdgeSwipesOffset[DragEdge.Right.ordinal()] =
			a.getDimension(R.styleable.SwipeLayout_SL_rightEdgeSwipeOffset, 0);
		mEdgeSwipesOffset[DragEdge.Top.ordinal()] =
			a.getDimension(R.styleable.SwipeLayout_SL_topEdgeSwipeOffset, 0);
		mEdgeSwipesOffset[DragEdge.Bottom.ordinal()] =
			a.getDimension(R.styleable.SwipeLayout_SL_bottomEdgeSwipeOffset, 0);
		setClickToClose(a.getBoolean(R.styleable.SwipeLayout_SL_clickToClose, mClickToClose));
		...
		int ordinal = a.getInt(R.styleable.SwipeLayout_SL_show_mode, ShowMode.PullOut.ordinal());
	 ...
	 * 设置左边是否能滑动
	 *
	 * @param leftSwipeEnabled 左边是否能滑动
	 */
	 ...
	 * 设置右边是否能滑动
	 *
	 * @param rightSwipeEnabled 右边是否能滑动
	 */
	 ...
	 * 设置下边是否能滑动
	 *
	 * @param bottomSwipeEnabled 下边是否能滑动
	 */
	...
	/**
	 * 设置菜单项目划出模式
	 * {@link ShowMode}.PullOut 看起来是在旁边被拉扯进来
	 * {@link ShowMode}.LayDown 看起来一直在底部
	 */
