...
public abstract class PullToZoomBase<T extends View> extends LinearLayout implements IPullToZoom<T>
{
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            int zoomViewResId = a.getResourceId(R.styleable.PullToZoomView_PTZV_zoomView, 0);
            if (zoomViewResId > 0) {
                mZoomView = mLayoutInflater.inflate(zoomViewResId, null, false);
            }

            int headerViewResId = a.getResourceId(R.styleable.PullToZoomView_PTZV_headerView, 0);
            if (headerViewResId > 0) {
                mHeaderView = mLayoutInflater.inflate(headerViewResId, null, false);
            }

            isParallax = a.getBoolean(R.styleable.PullToZoomView_PTZV_isHeaderParallax, true);
