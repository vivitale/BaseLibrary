 ...
 */
public class BGARecyclerViewHolder extends RecyclerView.ViewHolder implements
		View.OnClickListener, View.OnLongClickListener
{
	...
	public BGARecyclerViewHolder(View itemView,
	...
	public boolean onLongClick(View v)
	{
		...
		{
			return mOnRVItemLongClickListener.onRVItemLongClick(v,
					getAdapterPosition());
		}
		return false;
	}
