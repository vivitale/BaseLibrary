package talex.zsw.baselibrary.view.WaveLoadingView;
...
public class WaveLoadingView extends View {
    ...
    private float mWaterLevelRatio = 0.0f;
...
//        mWaveShader = null;
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB) public void setProgressValue(int progress) {
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB) private void initAnimation() {
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB) private void cancel() {
        if (mAnimatorSet != null) {
            mAnimatorSet.end();
        }
    }
