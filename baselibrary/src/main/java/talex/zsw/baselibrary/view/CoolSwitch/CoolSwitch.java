package talex.zsw.baselibrary.view.CoolSwitch;
/*
...
public class CoolSwitch extends ToggleButton implements CompoundButton.OnCheckedChangeListener
{
	...
	{
		TypedArray a =
			context.getTheme().obtainStyledAttributes( attrs, R.styleable.CoolSwitch, 0, 0 );

		try
		{
			disabledViewId = a.getResourceId( R.styleable.CoolSwitch_CS_disabledView, NO_ID );
			enabledViewId = a.getResourceId( R.styleable.CoolSwitch_CS_enabledView, NO_ID );
		} finally
		{
			a.recycle();
		}
	...
	@Override protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		backgroundRect
			.set( borderPadding, borderPadding, width - borderPadding, height - borderPadding );
	...
	@Override public void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
	{
		...
		ObjectAnimator.ofFloat( CoolSwitch.this, "animationProgress", 0, 1 )
			.setDuration( MOVEMENT_ANIMATION_DURATION_MS ).start();
	}
	...
	@SuppressWarnings("unused") public void setBackgroundAlpha(int backgroundAlpha)
	{
	...
	@SuppressWarnings("unused") public void setAnimationProgress(float animationProgress)
	{
