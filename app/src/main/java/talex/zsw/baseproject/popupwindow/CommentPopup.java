...
import talex.zsw.baselibrary.view.BasePopupWindow.utils.DimensUtils;
...
public class CommentPopup extends BasePopupWindow implements View.OnClickListener
{
	...
	private void buildAnima()
	{
		ScaleAnimation mScaleAnimation =
			new ScaleAnimation( 1f, 2f, 1f, 2f, Animation.RELATIVE_TO_SELF, 0.5f,
	...
	@Override public Animation getExitAnimation()
	{
	...
	public void setOnCommentPopupClickListener(
