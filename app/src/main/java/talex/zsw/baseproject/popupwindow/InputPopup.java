...
public class InputPopup extends BasePopupWindow implements View.OnClickListener
{
	...
	@Override public View getInputView()
	{
	...
	@Override public Animator getExitAnimator()
	{
		...
		if(android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.HONEYCOMB)
		{
			...
			{
				set.playTogether( ObjectAnimator.ofFloat( getAnimaView(), "translationY", 0, 250 )
					.setDuration( 400 ), ObjectAnimator.ofFloat( getAnimaView(), "alpha", 1, 0.4f )
					.setDuration( 250 * 3 / 2 ) );
			}
		}
		return set;
