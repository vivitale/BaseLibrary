...
public class ListPopup extends BasePopupWindow
{
	...
	private void setAdapter(Activity context, Builder builder)
	{
		...
		final ListPopupAdapter adapter =
			new ListPopupAdapter( context, builder.getItemEventList() );
	...
	//=============================================================super methods
	@Override public Animation getShowAnimation()
	{
		return null;
	}

	@Override public Animator getShowAnimator()
	{
		AnimatorSet set = new AnimatorSet();
		set.playTogether(
			ObjectAnimator.ofFloat( mAnimaView, "rotationX", 90f, 0f ).setDuration( 400 ),
	...
	@Override public Animator getExitAnimator()
	{
		AnimatorSet set = new AnimatorSet();
		set.playTogether(
			ObjectAnimator.ofFloat( mAnimaView, "rotationX", 0f, 90f ).setDuration( 400 ),
	...
	public void setOnListPopupItemClickListener(
		OnListPopupItemClickListener onListPopupItemClickListener)
	{
