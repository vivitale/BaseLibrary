...
public class MainActivity extends BaseAppCompatActivity implements OnItemClickListener
{
	...
	@Override protected void initData()
	{
		...
		datas.add(new Vo("OverScroll-Decor", "可以给任意View加上阻尼效果",
			OverScrollActivity.class));
		...
		datas.add(new Vo("SwitchAnimation", "使View中的项目带有动画效果入场", SwitchAnimationActivity.class));
