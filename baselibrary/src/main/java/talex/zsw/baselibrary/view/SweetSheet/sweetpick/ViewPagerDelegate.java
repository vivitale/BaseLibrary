...
import talex.zsw.baselibrary.view.SweetSheet.adapter.ViewpagerAdapter;
...
import talex.zsw.baselibrary.view.SweetSheet.widget.IndicatorView;
...
public class ViewPagerDelegate extends Delegate {
    ...
    protected View createView(int SScolor,int BGcolor) {
        View rootView = LayoutInflater.from(mParentVG.getContext()).inflate(R.layout.sweetsheet_layout_vp_sweet, null, false);
