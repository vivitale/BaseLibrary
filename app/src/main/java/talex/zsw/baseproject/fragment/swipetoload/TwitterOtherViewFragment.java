 ...
 */
public class TwitterOtherViewFragment extends BaseFragment
	implements OnRefreshListener, OnLoadMoreListener
{
		...
		Bundle savedInstanceState)
	{
		...
		{
			view =
				inflater.inflate( R.layout.fragment_twitter_other_framelayout, container, false );
		}
		else if(mTitle.equals( "RelativeLayout" ))
		{
			view = inflater
				.inflate( R.layout.fragment_twitter_other_relativelayout, container, false );
		}
		else if(mTitle.equals( "LinearLayout" ))
		{
			view =
				inflater.inflate( R.layout.fragment_twitter_other_linearlayout, container, false );
		}
			...
			@Override public void run()
			{
				if(ivContent != null)
				{
					Picasso.with( getActivity() )
						.load( "https://avatars0.githubusercontent.com/u/1912775?v=3&s=460" )
						.into( ivContent );
				}
				swipeToLoadLayout.setRefreshing( false );
			}
