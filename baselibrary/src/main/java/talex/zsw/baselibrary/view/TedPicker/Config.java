...
public class Config {
    ...
    private int cameraBtnImage = R.drawable.picker_camera;
    private int cameraBtnBackground = R.drawable.picker_btn_bg;

    private int selectedCloseImage = R.drawable.picker_clear;
