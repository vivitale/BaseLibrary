...
public class GoogleCircleProgressView extends ImageView
{
	...
	private void init(Context context, AttributeSet attrs, int defStyleAttr)
	{
		final TypedArray a = context
			.obtainStyledAttributes( attrs, R.styleable.GoogleCircleProgressView, defStyleAttr, 0 );
		...
		mTextSize =
			a.getDimensionPixelOffset( R.styleable.GoogleCircleProgressView_gcp_progress_text_size,
	...
	@Override protected void onLayout(boolean changed, int left, int top, int right, int bottom)
	{
		...
		if(getBackground() == null && mCircleBackgroundEnabled)
		{
			...
			else
			{
				...
				ViewCompat
					.setLayerType( this, ViewCompat.LAYER_TYPE_SOFTWARE, mBgCircle.getPaint() );
