...
public class CustomTimePicker extends TimePicker
{
    ...
    public CustomTimePicker(Context context, AttributeSet attrs)
    {
        ...
        {
            KLog.e(TAG, "ClassNotFoundException in CustomTimePicker", e);
        }
        catch (NoSuchFieldException e)
        {
            KLog.e(TAG, "NoSuchFieldException in CustomTimePicker", e);
        }
        catch (IllegalAccessException e)
        {
            KLog.e(TAG, "IllegalAccessException in CustomTimePicker", e);
        }
        catch (IllegalArgumentException e)
        {
            KLog.e(TAG, "IllegalArgumentException in CustomTimePicker", e);
        }
    }
}
