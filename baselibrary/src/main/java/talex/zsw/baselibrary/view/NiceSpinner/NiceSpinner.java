...
public class NiceSpinner extends TextView
{
	...
	private void init(Context context, AttributeSet attrs)
	{
		...
		int defaultPadding = resources
				.getDimensionPixelSize(R.dimen.nice_spinner_one_and_a_half_grid_unit);

		setGravity(Gravity.CENTER_VERTICAL | Gravity.LEFT);
		setPadding(
				resources
						.getDimensionPixelSize(R.dimen.nice_spinner_three_grid_unit),
		...
		if (Build.VERSION.SDK_INT >= 21)
		{
			...
			mPopup.setBackgroundDrawable(ContextCompat.getDrawable(context,
				R.drawable.nice_spinner_drawable));
		}
		else
		{
			mPopup.setBackgroundDrawable(ContextCompat.getDrawable(context,
				R.drawable.nice_spinner_drop_down_shadow));
		}
