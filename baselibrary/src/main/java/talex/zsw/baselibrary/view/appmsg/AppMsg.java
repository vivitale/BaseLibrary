...
package talex.zsw.baselibrary.view.appmsg;
 ...
 * @author e.shishkin
 */
@SuppressWarnings("ALL") public class AppMsg
{
	 ...
	 *
	 * @param context The context to use. Usually your {@link Activity}
	 *                object.
	...
	public static AppMsg makeText(Activity context, CharSequence text,
								  Style style)
	{
		return makeText(context, text, style, R.layout.widget_appmsg);
	}
	 ...
	 * @param text     The text to show. Can be formatted text.
	 * @param style    The style with a background and a duration.
	 * @param textSize mengguoqiang 扩展支持设置字体大小
	 *                 Make a {@link AppMsg} that just contains a text view.
	 */
	public static AppMsg makeText(Activity context, CharSequence text,
								  Style style, float textSize)
	{
		return makeText(context, text, style, R.layout.widget_appmsg, textSize);
	}

	/**
	 * Make a {@link AppMsg} with a custom layout. The layout must have a
	 * {@link TextView} com id {@link android.R.id.message}
	 * 扩展支持设置布局样式,其中,布局中必须要有一个TextView并且其id为message
	 *
	 * @param context The context to use. Usually your {@link Activity}
	 *                object.
	 * @param text    The text to show. Can be formatted text.
	 ...
	 * @param text     The text to show. Can be formatted text.
	 * @param style    The style with a background and a duration.
	 * @param textSize mengguoqiang 扩展支持字体大小
	 *                 Make a {@link AppMsg} with a custom layout. The layout must have
	 ...
	 * @param floating true if it'll float.
	 * @param textSize mengguoqiang 扩展支持设置字体大小
	 *                 Make a {@link AppMsg} with a custom view. It can be used to
	 *                 create non-floating notifications if floating is false.
	 */
	private static AppMsg makeText(Activity context, CharSequence text,
	 ...
	 * .
	 * If there is a {@link AppMsg} displayed currently, it will be the last one
	 * displayed.
	 *
	 * @param activity
	 */
