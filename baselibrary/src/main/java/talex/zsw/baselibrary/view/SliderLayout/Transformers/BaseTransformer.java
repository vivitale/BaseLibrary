 ...
 * <p/>
 * BaseTransformer implement {@link talex.zsw.baselibrary.view.SliderLayout.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 * <p/>
 * After you call setPageTransformer(), transformPage() will be called by {@link talex.zsw.baselibrary.view.SliderLayout.Tricks.ViewPagerEx}
 * when your slider are animating.
 * <p/>
 * In onPreTransform() function, that will make {@link talex.zsw.baselibrary.view.SliderLayout.Animations.BaseAnimationInterface}
 * work.
 * <p/>
