 ...
 */
package talex.zsw.baselibrary.view.CommonAdapter.listviewanimations.itemmanipulation;
...
public class SwipeDismissListViewTouchListener implements SwipeOnTouchListener {
	...
	private boolean handleDownEvent(MotionEvent motionEvent) {
		...
		if (downView != null) {
			KLog.d("SwipeDismissListViewTouchListener", "hit child !");
	...
	private boolean handleMoveEvent(MotionEvent motionEvent) {
		...
		if (mSwiping) {
			if (!mSwipeInitiated) {
				KLog.d("SwipeDismissListViewTouchListener", "swipe/begin");
			}
	...
	private boolean handleUpEvent(MotionEvent motionEvent) {
		...
		if (mSwiping) {
			if (dismiss) {
				KLog.d("SwipeDismissListViewTouchListener", "swipe/confimed");
				...
				KLog.d("SwipeDismissListViewTouchListener", "swipe/cancelled");
				// cancel
	...
	protected void performDismiss(final PendingDismissData data) {
		...
		KLog.d("SwipeDismissListViewTouchListener", "performDismiss");
