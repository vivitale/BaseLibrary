...
public class ViewUtils
{
	...
	public static void removeGlobalListeners(View target,
	 ...
	 * @param visible false if need to set {@link View#GONE} flag
	 */
	 ...
	 *
	 * @param view to check
	 * @return true if {@link View#getVisibility()}
	 * equals to {@link View#VISIBLE}
	 */
