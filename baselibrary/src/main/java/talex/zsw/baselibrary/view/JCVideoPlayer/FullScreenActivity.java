...
public class FullScreenActivity extends Activity
{
	...
	public static void toActivity(Context context, int state, String url, String thumb,
		String title)
	{
		STATE = state;
		URL = url;
	...
	@Override protected void onCreate(Bundle savedInstanceState)
	{
		...
		if(skin != null)
		{
			jcVideoPlayer.setSkin( skin.titleColor, skin.timeColor, skin.seekDrawable,
				skin.bottomControlBackground, skin.enlargRecId, skin.shrinkRecId );
		}
