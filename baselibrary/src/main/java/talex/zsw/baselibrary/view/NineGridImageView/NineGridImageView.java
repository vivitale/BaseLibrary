package talex.zsw.baselibrary.view.NineGridImageView;
...
public class NineGridImageView<T> extends ViewGroup
{
	...
	public NineGridImageView(Context context, AttributeSet attrs)
	{
		...
		TypedArray typedArray =
			context.obtainStyledAttributes( attrs, R.styleable.NineGridImageView );
	...
	@Override protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		if(mImgDataList != null && mImgDataList.size() > 0)
		{
			...
			height = mGridSize * mRowCount + mGap * (mRowCount - 1) + getPaddingTop() +
				getPaddingBottom();
